...
const Footer = () => {
  return (
    <footer className="mt-36 bg-dark lg:rounded-t-[45px] px-[60px] pt-[55px] pb-[50px]">
      <section className="flex flex-col lg:flex-row gap-12 justify-between items-center lg:items-end">
        ...
        <nav className="flex flex-col lg:flex-row items-center gap-8 list-none">
      ...
      <section className="flex flex-col gap-10 lg:gap-3 lg:flex-row justify-between mt-[66px]">
        <div className="flex flex-col gap-3 lg:gap-0 lg:justify-between text-white text-center lg:text-start">
          <h3 className="text-black font-bold inline mb-12 lg:mb-0">
        ...
        <div className="bg-[#292A32] px-10 py-14 rounded-[14px]">
          <form className="flex flex-col lg:flex-row gap-5">
            <input
              type="email"
              placeholder="Email"
              className="bg-transparent px-4 xl:px-9 py-5 rounded-[14px] border border-white text-white"
            />
            <button className="bg-green px-4 xl:px-9 py-5 rounded-[14px]">
              Subscribe to news
            </button>
          </form>
        </div>
      ...
      <div className="lg:hidden flex justify-center gap-3 mt-[50px]">
        <span>
      ...
      <div className="mt-[50px] flex flex-col lg:flex-row items-center lg:items-end gap-8  text-white">
